...
import Del from '~/components/both/Typography/Del';
import Span from '~/components/both/Typography/Span';
import U from '~/components/both/Typography/U';
...
import { Ul, Ol, Li } from '~/components/both/Typography/List';
